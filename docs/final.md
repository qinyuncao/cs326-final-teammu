...
### **Division Of Labor**: 
- Qinyun Cao : Come up with project idea with groupmates. Set up Wireframes for the "main page" and all the headers. Work with teammates to finalize wireframes for all UIs. Create mongoDB database and implement primarily for server. Implements the GET and POST requests to connect the mongoDB database. Added some modification and decoration to the frontend. Coded specific aspects of all HTML and CSS for the app.
...
- Yingxun Wei : Helped adding ideas for each project page. Set up wireframes for the “Residential Hall Ranking” page and the link - specific factors rating page. Worked with our group to finalize wireframes for all UIs. Coded CSS and HTML for the “Residential Hall Ranking” page, “Log In” page and “Sign Up” page. Coded some frontend Javascript and fixed some updates and bugs in JavaScript codes related html. Implemented GET and POST requests for review page to connect the mongoDB database with the frontend. Finally checked all pages work and fixed bugs.
